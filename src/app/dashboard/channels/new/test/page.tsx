  ...
  return (
    <div className="flex flex-col xl:flex-row h-screen bg-white dark:bg-gray-950 transition-colors duration-200 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto px-4 md:px-6 xl:px-10 py-4 md:py-6 xl:py-8">
        ...
        {/* Chat preview window */}
        <div className="max-w-2xl border border-gray-200 dark:border-gray-700 rounded-lg md:rounded-2xl bg-white dark:bg-gray-900 transition-colors duration-200 overflow-hidden">
          {/* Chat header */}
          ...
          {/* Messages */}
          <div className="px-3 md:px-5 py-3 md:py-5 space-y-3 md:space-y-4 min-h-[220px] md:min-h-[280px] max-h-[280px] md:max-h-[360px] overflow-y-auto bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
            {!tested && !loading && (
        ...
        {/* Action buttons */}
        <div className="flex items-center justify-end gap-2 md:gap-3 mt-4 md:mt-6 max-w-2xl flex-wrap">
          {tested ? (
            <>
              <button
                type="button"
              ...
              <button
                ...
                className="bg-[#14A085] hover:bg-[#0d7a65] dark:bg-emerald-600 dark:hover:bg-emerald-700 text-white font-semibold rounded-lg md:rounded-xl px-4 md:px-6 py-2 md:py-2.5 text-xs md:text-sm transition-colors"
              >
                Activate Channel
              </button>
            </>
            ...
            <button
              ...
              onClick={runTest}
              disabled={loading}
              className="flex items-center justify-center gap-2 bg-[#14A085] hover:bg-[#0d7a65] dark:bg-emerald-600 dark:hover:bg-emerald-700 text-white font-semibold rounded-lg md:rounded-xl px-6 md:px-8 py-2 md:py-3 text-xs md:text-sm transition-colors disabled:opacity-60 w-full md:w-auto"
            >
              {loading ? (
