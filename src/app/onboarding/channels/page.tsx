...
const CHANNELS = [
  ...
  { id: "telegram",         Icon: Telegram,         name: "Telegram",            desc: "Engage with your audience in real-time" },
...
export default function ChannelsPage() {
  ...
  return (
    <div className="h-screen bg-[#F1F5F9] dark:bg-gray-950 flex transition-colors duration-200 flex-col items-center px-4 pt-20 pb-16">
    <div className="h-screen  mt-12 ">
      <div className="w-full hidden xl:block xl:ml-36 max-w-2xl">
        <Stepper current={3} />
      </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute top-3 right-3 ">
                          <div
                            className={`h-4 w-4 xl:w-5 xl:h-5 pt-1 rounded-full border-2 flex items-center justify-center transition-colors ${
                        ...
                        <div className={popular ? "mt-6 xl:mb-3" : "mb-3"}>
                          <Icon  />
                        </div>
