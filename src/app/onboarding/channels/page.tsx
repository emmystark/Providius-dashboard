                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-3 right-3 ">
                      <div
                        className={`h-4 w-4 xl:w-5 xl:h-5 pt-1 rounded-full border-2 flex items-center justify-center transition-colors ${on ? "border-none dark:text-black " : "border-gray-300"
                          }`}
                      >
                        {on && <CheckIcon />}
                      </div>
