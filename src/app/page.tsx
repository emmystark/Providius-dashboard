  ...
  return (
    <div className=" bg-gray-100 flex items-center justify-center">
      <div className="w-full  bg-white h-[100vh] shadow-2xl overflow-hidden flex flex-col md:flex-row ">
        ...
        {/* ── Left teal panel ── */}
        <div  className="md:w-[50%] pt-20 bg-[#0D9488] flex flex-col p-16 px-20 relative overflow-hidden bg-gradient-to-br from-[#0D9488] to-[#0D9488]-dark">
          {/* Logo */}
          <div className="flex">
            <div className="flex items-center gap-2.5 mb-12">
            <img className="w-16 ml-0 mx-[-60px] absolute" src="./logoa.png" alt="" />
          </div>
            <h3 className="text-4xl text-white font-bold ml-20 mt-[-20]">Providius</h3>
          </div>
          ...
          <p className="text-white/80 text-[17px] leading-relaxed mb-3">
          ...
          {/* <div className="flex-1 relative rounded-2xl overflow-hidden bg-white/10 min-h-[220px]"> */}
            ...
            <img className="w-[92%] h-[80%]" src="./lady.png" alt="" />
            

            {/* Stats bar */}
            <div className="absolute bottom-10 w-[63%] left-24 right-0 flex gap-10  m-10 ">
              {[
        ...
        <div className="flex-1 flex text-xl flex-col bottom-2 relative justify-center px-12 py-14 bg-[#F8FAFC]">
          ...
          <form action="/onboarding/workspace">
            ...
            <div>
              ...
              <input
                type="email"
                className="w-full border-none border-gray-200 rounded-xl px-4 py-4 text-lg text-gray-900 placeholder-gray-400 bg-white outline-none transition-all focus:border-[#0D9488] focus:ring-2 focus:ring-[#0D9488]/10"
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="submit" className="w-full bg-[#0D9488] hover:bg-[#0D9488]-dark mt-8 text-white font-semibold rounded-2xl px-6 transition-colors cursor-pointer py-4 text-lg">Sign In</button>
